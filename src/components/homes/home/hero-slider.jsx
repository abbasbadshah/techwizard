...
const hero_content = {
    ...
    hero_title: <div><span className='tp_title'><span className='child'>The Leading Customer</span></span> <br />
        <span><span className='child'>Data Platform</span></span> </div>,
    sub_title: <div>We are not going to save your data</div>,
    hero_shape_img: [
        {
            id: 1,
            cls: "1",
