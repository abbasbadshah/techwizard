...
const job_data = {
    ...
    title: <div>Join our Growing Team <br /> of Doors.</div>,
    carrer_title: "Open Positions",
    carrer_info: <div>Borem ipsum dolor sit amet, consectetur adipiscing elit. Nulla scelerisque tristique <br/>
    Et amet risus enim accumsan sit purus sit.</div>,
    job_info: [
        {
            id:1, 
