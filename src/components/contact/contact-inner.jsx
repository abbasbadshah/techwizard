...
const inner_content = {
  title: "Book a Demo!",
  description: <div>We will contact again after receive your request in 24h</div>,

  contact_data: [
    {
      id: 1,
      icon: icon_1,
      title: "contact@techwizard.com",
      link: "mailto:contact@techwizard.com",
    },
    {
      id: 2,
      icon: icon_2,
      title: "+91 91311 23541",
      link: "tel:+919131123541",
    },
    {
      id: 3,
      icon: icon_3,
