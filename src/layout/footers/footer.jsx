...
import footer_logo from "../../../public/assets/img/logo/tw-logo.png";
import { useIsomorphicLayoutEffect } from '@/src/hooks/useIsomorphicEffect';


// footer_content 
const footer_content  = {
    title: <div>Get Our Latest's News <br /> & Updates</div>,
    description: <div>Our highly skilled development teams <br /> specialized in data analysis.</div>,
    phone: "+806(000)8899",
    contact_mail: "contact@info.com",
    location: "1234 North Avenue Luke Lane, South Bend,",

    copy_right: <div>Full Copyright & Design By <Link href="/">@Theme pure</Link> – {new Date().getFullYear()}</div>,
