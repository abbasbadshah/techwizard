...
import footer_logo from "../../../public/assets/img/logo/gt-logo-n.webp";


const footer_content = {
    info:"Build a modern and creative website with crealand",
    phone: "+91 9131123541",
    email: "contact@techwizard.com",
    ...
    footer_links : [
        {
            ...
            links: [
                ...
                {name: "UI/UX Development", link: "#"},
                {name: "Frontend Development", link: "#"},
                {name: "Seo Optimizations", link: "#"},
                {name: "Backend Development", link: "#"},
                {name: "Graphics and Visuals Designing", link: "#"},
            ]
        },
        {
            id: 2,
...
const {info, phone, email, footer_links}  = footer_content
